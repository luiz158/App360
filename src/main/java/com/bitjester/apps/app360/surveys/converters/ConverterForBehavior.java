package com.bitjester.apps.app360.surveys.converters;
...
@Named
@RequestScoped
public class ConverterForBehavior implements Converter {
	@Inject
	...
	public Object getAsObject(FacesContext arg0, UIComponent arg1, String arg2) {
		if (null != arg2 && !arg2.contains("---"))
			return em.find(Behavior.class, Long.valueOf(arg2));
		return null;
	}
